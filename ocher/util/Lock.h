 ...
 *  @note  For an exception-safe version of the lock (locks only a scope), see Locker.
 */
class Lock {
public:
    /**
...
public:
    ...
    bool lockWithTimeout(unsigned int)
    {
        return true;
    }
    void unlock()
...
#ifndef SINGLE_THREADED
/**
 *  Like Lock, but constructor automatically locks and destructor unlocks.  Useful for
